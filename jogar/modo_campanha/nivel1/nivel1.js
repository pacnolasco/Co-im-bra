...
var spArray = [];
spArray.push(new Jogador(780,580, 0,"../../../resources/personagem_m.png"));
...
function loadHandler()
{
	...
	paredes.push(new Elemento(170,0,canvas.width,105));
	paredes.push(new Elemento(690,105,canvas.width-690,227-120));
	paredes.push(new Elemento(842,222,canvas.width,canvas.height));
	paredes.push(new Elemento(825,584,canvas.width,canvas.height));

	paredes.push(new Elemento(0,575,730,622-582));

	paredes.push(new Elemento(0,0,80,579));
...
function update()
{
	...
	if (pontos >= 2000)
	{
		...
		next.onclick = function (){window.location.assign("../nivel2/nivel2.html");};
	}
...
/*
if (this.y > canvas.height-this.height && this.x>729 && this.x<821){
			this.y = 0;
			this.x = 127;
		}

		if (this.y < 0 && this.x > 75 && this.x < 149){
			this.y = canvas.height-this.height;
			this.x = 775
		}
		console.log("Jog: ",this.x, this.y);*/