...
function loadHandler()
{
	...
	paredes.push(new Elemento(372,175,755-379,346-185));

	paredes.push(new Elemento(144,170,329-153,346-180));

	paredes.push(new Elemento(0,165,68,346-175));
	paredes.push(new Elemento(860,165,canvas.width,348-172));

	paredes.push(new Elemento(428,7,497-434,31-13));
	paredes.push(new Elemento(107,210,133-117,287-215));
	paredes.push(new Elemento(709,452,766-715,479-458));
	paredes.push(new Elemento(399,530,470-403,555-535));
...
function update()
{
	...
	if (pontos >= 2000)
	{
		...
		next.onclick = function (){window.location.assign("../nivel3/nivel3.html");};
	}
